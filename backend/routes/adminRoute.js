...
import { getAdminNotifications, markAdminNotificationsRead } from '../controllers/notificationController.js';
...
adminRouter.post("/notifications/mark-read", authAdmin, markAdminNotificationsRead)
